    ...
    def _command_search_launcher(self, categoryID, launcherID):
        ...
        if type == type_nb:
            ...
            if keyboard.isConfirmed():
                ...
                # xbmc.executebuiltin('ReplaceWindow(Programs,{})'.format(url))
                xbmc.executebuiltin('ActivateWindow(Programs,{})'.format(url))
