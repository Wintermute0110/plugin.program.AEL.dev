...
class Main:
    ...
    def _command_export_collection(self, categoryID, launcherID):
        ...
        if export_type == 1:
            ...
            fs_export_ROM_collection_assets(output_FileName, collection, collection_rom_list, collections_asset_dir_FileName)
    ...
    def _command_run_rom(self, categoryID, launcherID, romID):
        ...
        if rom['altapp']:
            ...
            arg_list = list().append(standard_args) + args_extra
            dialog = xbmcgui.Dialog()
