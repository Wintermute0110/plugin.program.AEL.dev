...
SCRAPE_META_ACTION_TITLE_ONLY = 0
SCRAPE_META_ACTION_NFO_PREFERED = 1
SCRAPE_META_ACTION_NFO_AND_SCRAPE = 2
SCRAPE_META_ACTION_SCRAPE_ONLY = 3

SCRAPE_ASSET_ACTION_LOCAL_ONLY = 0
SCRAPE_ASSET_ACTION_LOCAL_AND_SCRAPE = 1
SCRAPE_ASSET_ACTION_SCRAPE_ONLY = 2
