...
SCRAP_METADATA_SETTINGS_LIST = [
    SCRAPER_NULL_ID, SCRAPER_AEL_OFFLINE_ID,
    SCRAPER_THEGAMESDB_ID, SCRAPER_MOBYGAMES_ID, SCRAPER_SCREENSCRAPER_ID,
]
...
SCRAP_METADATA_MAME_SETTINGS_LIST = [
    SCRAPER_NULL_ID, SCRAPER_AEL_OFFLINE_ID,
    SCRAPER_ARCADEDB_ID, SCRAPER_SCREENSCRAPER_ID, SCRAPER_THEGAMESDB_ID, SCRAPER_MOBYGAMES_ID,
]
